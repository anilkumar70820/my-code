                ...
                <Row>
                    {CardMaping.map((data) =>{
                        return(
                            ...
                            <Col key={data.id} lg={4} sm={6} xs={12} className='d-flex flex-column justify-content-center mb-5' data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">
                            <div className='invest_cards'>
                                <div className='d-flex justify-content-center mb-3'>
                                    <img src={data.img} alt="coin" />
                                </div>
                                <h2 className='ff_open_sans fs_3xmd fw-bold text_252B42 text-center mb-4'>{data.heading}</h2>
                                <p className='ff_open_sans fs_sm fw-normal text_222B32 text-center'>{data.paragraph}</p>
                            </div>
                        </Col>
                        );
                    }
